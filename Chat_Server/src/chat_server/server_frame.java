...
public class server_frame extends javax.swing.JFrame {
    // arraylist to store the client's socket and output streams for each client
    ...
    // Thread activation to read from a particular client
    public class ClientHandler implements Runnable
    {
        BufferedReader reader;

        // to accept the socket connections from the client
        Socket sock;
        PrintWriter client;
    ...
    public class ServerStart implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                while (true) {
                    // local to that while loop
                    Socket clientSock = serverSock.accept();
                    PrintWriter writer = new PrintWriter(clientSock.getOutputStream());
                    clientOutputStreams.add(writer);
                    sockets.add(clientSock);

                    // new thread for each of client
